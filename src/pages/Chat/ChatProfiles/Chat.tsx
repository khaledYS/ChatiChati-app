...
function Chat(props: Props) {
    ...
    return (
        <Link to={chatId} style={{ "boxShadow": "rgb(42, 42, 42) 0px 0px 7px -7px inset, rgb(42, 42, 42) 0px 0px 3px -1px"}} className='w-full px-2 py-2 w bg-[#e3e3e3] hover:bg-[#c3c3c3] transition-all hover:cursor-pointer rounded-md mt-2 flex overflow-hidden'>
